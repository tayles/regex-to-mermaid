...
export const THEME_NODE_STYLES: Record<ThemeWithStyles, Record<NodeType, string>> = {
  default: {
    ...
    'negated-char-set': 'fill:#EF9A9A,stroke:#E53935,color:#000000',
  ...
  neutral: {
    ...
    'negated-char-set': 'fill:#B8B8B8,stroke:#686868',
  ...
  dark: {
    ...
    'negated-char-set': 'fill:#3A2828,stroke:#F44336,color:#FFFFFF',
  ...
  forest: {
    ...
    'negated-char-set': 'fill:#FFCC80,stroke:#FB8C00',
